...
// Given an SQL string with variadic arguments, allocate argumentBinary and argumentLengths, and
// hold the parameters in binary format Last 2 parameters are out parameters
void ExtractArguments(va_list argptr, const DataStructures::List<IndexAndType> &indices, char ***argumentBinary,
                      int **argumentLengths);
