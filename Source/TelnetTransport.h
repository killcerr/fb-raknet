...
/// \details To run Windows telnet, go to your start menu, click run, and in the edit box type
/// "telnet <IP>" where <IP> is the ip address.<BR> of your ConsoleServer (most likely the same IP
/// as your game).<BR> This implementation always echos commands.
class RAK_DLL_EXPORT TelnetTransport : public TransportInterface {
  ...
  protected:
   ...
   // Crap this sucks but because windows telnet won't send line at a time, I have to reconstruct
   // the lines at the server per player
