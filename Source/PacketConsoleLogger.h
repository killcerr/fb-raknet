...
/// \file
/// \brief This will write all incoming and outgoing network messages to the log command parser,
/// which can be accessed through Telnet
///
...
class RAK_DLL_EXPORT PacketConsoleLogger : public PacketLogger {
  public:
   PacketConsoleLogger();
   // Writes to the command parser used for logging, which is accessed through a secondary
   // communication layer (such as Telnet or RakNet) - See ConsoleServer.h
