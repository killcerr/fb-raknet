...
/// through NatPunchthroughClient<BR> Server maintains two sockets clients can connect to so as to
/// estimate the next port choice<BR> Server tells other client about port estimate, current public
/// port to the server, and a time to start connection attempts \sa NatTypeDetectionClient See also
/// http://www.jenkinssoftware.com/raknet/manual/natpunchthrough.html \ingroup
/// NAT_PUNCHTHROUGH_GROUP
