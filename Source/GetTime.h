...
/// \file GetTime.h
/// \brief Returns the value from QueryPerformanceCounter.  This is the function RakNet uses to
/// represent time. This time won't match the time returned by GetTimeCount(). See
...
/// \note The maximum delta between returned calls is 1 second - however, RakNet calls this
/// constantly anyway. See NormalizeTime() in the cpp.
