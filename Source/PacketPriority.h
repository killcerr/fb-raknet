...
/// \note  Note to self: I write this with 3 bits in the stream.  If I add more remember to change
/// that \note In ReliabilityLayer::WriteToBitStreamFromInternalPacket I assume there are 5 major
