...
// If you want to change these defines, put them in NativeFeatureIncludesOverrides so your changes
// are not lost when updating RakNet The user should not edit this file
#include "NativeFeatureIncludesOverrides.h"

#ifndef __NATIVE_FEATURE_INCLDUES_H
#define __NATIVE_FEATURE_INCLDUES_H

// Uncomment below defines, and paste to NativeFeatureIncludesOverrides.h, to exclude plugins that
// you do not want to build into the static library, or DLL These are not all the plugins, only
// those that are in the core library Other plugins are located in DependentExtensions #define
// _RAKNET_SUPPORT_ConnectionGraph2 0 #define _RAKNET_SUPPORT_DirectoryDeltaTransfer 0 #define
// _RAKNET_SUPPORT_FileListTransfer 0 #define _RAKNET_SUPPORT_FullyConnectedMesh2 0 #define
// _RAKNET_SUPPORT_MessageFilter 0 #define _RAKNET_SUPPORT_NatPunchthroughClient 0 #define
// _RAKNET_SUPPORT_NatPunchthroughServer 0 #define _RAKNET_SUPPORT_NatTypeDetectionClient 0 #define
// _RAKNET_SUPPORT_NatTypeDetectionServer 0 #define _RAKNET_SUPPORT_PacketLogger 0 #define
// _RAKNET_SUPPORT_ReadyEvent 0 #define _RAKNET_SUPPORT_ReplicaManager3 0 #define
// _RAKNET_SUPPORT_Router2 0 #define _RAKNET_SUPPORT_RPC4Plugin 0 #define
// _RAKNET_SUPPORT_TeamBalancer 0 #define _RAKNET_SUPPORT_TeamManager 0 #define
// _RAKNET_SUPPORT_UDPProxyClient 0 #define _RAKNET_SUPPORT_UDPProxyCoordinator 0 #define
// _RAKNET_SUPPORT_UDPProxyServer 0 #define _RAKNET_SUPPORT_ConsoleServer 0 #define
// _RAKNET_SUPPORT_RakNetTransport 0 #define _RAKNET_SUPPORT_TelnetTransport 0 #define
// _RAKNET_SUPPORT_TCPInterface 0 #define _RAKNET_SUPPORT_LogCommandParser 0 #define
// _RAKNET_SUPPORT_RakNetCommandParser 0 #define _RAKNET_SUPPORT_EmailSender 0 #define
// _RAKNET_SUPPORT_HTTPConnection 0 #define _RAKNET_SUPPORT_HTTPConnection2 0 #define
// _RAKNET_SUPPORT_PacketizedTCP 0 #define _RAKNET_SUPPORT_TwoWayAuthentication 0
