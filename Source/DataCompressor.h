...
/// \details Not very good compression, but it's small and fast so is something you can use
...
/// \brief Does compression on a block of data.  Not very good compression, but it's small and fast
/// so is something you can compute at runtime.
